...
def main():
    ...
    # Define file paths
    tename_path = os.path.join(Dataset_Home, 'tename.pkl')
    adata_path = os.path.join(Dataset_Home, 'raw_qc.h5ad')
    csv_path = os.path.join(Dataset_Home, 'scTE.csv')
    adata_scTE_path = os.path.join(Dataset_Home, 'raw_qc_scTE.h5ad')
    ...
    df1 = pd.read_csv("/gstore/scratch/u/ghaffars/scTE/APC_data/rep1/out_all.csv")
    df2 = pd.read_csv("/gstore/scratch/u/ghaffars/scTE/APC_data/rep2/out_all.csv")
